...
%if %{without legacy}
Obsoletes: iptables-legacy-libs-debuginfo < 1.8.10-9
Obsoletes: iptables-legacy-libs < 1.8.10-9
%endif
...
Requires: pkgconfig
%if %{without legacy}
Obsoletes: iptables-legacy-devel < 1.8.10-9
%endif
...
BuildArch: noarch
%if %{without legacy}
Obsoletes: iptables-services < 1.8.10-9
%endif
...
* Wed Nov 13 2024 Phil Sutter <psutter@redhat.com> [1.8.11-3.el10]
- More upgrade path from RHEL-10.0-beta fixing (Phil Sutter) [RHEL-66725]

* Wed Nov 13 2024 Phil Sutter <psutter@redhat.com> [1.8.11-2.el10]
...
* Wed Sep 11 2024 Phil Sutter <psutter@redhat.com> [1.8.10-11.el10]
- Bump release to trigger CI (Phil Sutter)
